...
public class Context {
    ...
    private void init() {
        ...
        builtinBinary("!=", (c, a, b) -> Decs.ne(a, b), "(A) != (B) -> (B) : A not equal B");
        builtinBinary("<", (c, a, b) -> Decs.lt(a, b), "(A) < (B) -> (B) : A less than B");
        builtinBinary("<=", (c, a, b) -> Decs.le(a, b), "(A) <= (B) -> (B) : A less than or equal B");
        builtinBinary(">", (c, a, b) -> Decs.gt(a, b), "(A) > (B) -> (B) : A greater than B");
        builtinBinary(">=", (c, a, b) -> Decs.ge(a, b), "(A) >= (B) -> (B) : A greater than or equal B");
        builtinBinary("~~", (c, a, b) -> Decs.nearlyEq(a, b), "(A) ~~ (B) -> (B) : A nearly equals B");
        builtinBinary("!~", (c, a, b) -> Decs.nearlyNe(a, b), "(A) !~ (B) -> (B) : A not nearly equals B");
        ...
        setter("EPSILON", (c, a) -> Decs.epsilon(a));
        ...
        binary("p+", (c, a, b) -> Decs.polyAdd(a, b), "(A) p+ (B) -> (D) : add (A) and (B) as polynomial");
        binary("p/", (c, a, b) -> {
            BigDecimal[][] dr = Decs.polyDivide(a, b);
            c.output.accept("remainder = " + Decs.string(dr[1])); // 剰余を中間表示する。
            return dr[0];
        }, "(A) p/ (B) -> (D) : divide (A) by (B) as polynomial");
        binary("p%", (c, a, b) -> Decs.polyMod(a, b), "(A) p% (B) -> (D) : mod (A) by (B) as polynomial");
        binary("p*", (c, a, b) -> Decs.polyMult(a, b), "(A) p* (B) -> (D) : multiply (A) and (B) as polynomial");
        binary("p^", (c, a, b) -> Decs.polyPow(a, b), "(A) p^ (B) -> (D) : power (A) by (B) as polynomial");
