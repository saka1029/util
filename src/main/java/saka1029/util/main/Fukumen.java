...
public class Fukumen {
    ...
    static final String USAGE = "usage: java saka1029.util.main.Fukumen (EXPRESSION | -f EXPRESSION_FILE)";
    ...
    public static void main(String[] args) throws IOException,
        ...
        if (args.length == 2 && args[0].equals("-f"))
            problem = FukumenParser.parse(Files.readString(Paths.get(args[1])));
        else if (args.length == 1)
            problem = FukumenParser.parse(args[0]);
        else
